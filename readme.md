...
- 🧠 Answers generated by a **local Ollama LLM** (no cloud APIs)
- 📄 Page-aware answers with **source citations**
- 🚫 Hallucination guard using similarity thresholds
- ⚙️ Auto-installs required Python dependencies
